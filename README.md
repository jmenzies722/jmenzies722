...
<a href="https://github.com/jmenzies722/aws-architect-mcp"><img src="./assets/cards/aws-architect-mcp.svg" width="48%" alt="AWS Architect MCP — reference AWS patterns for agents to pick from" /></a> <a href="https://github.com/jmenzies722/claude-max"><img src="./assets/cards/claude-max.svg" width="48%" alt="claude-max — scores a Claude Code setup 0 to 100" /></a>
<a href="https://github.com/jmenzies722/shua-labs"><img src="./assets/cards/shua-labs.svg" width="97%" alt="Shua Labs — tools for running AI agents in production" /></a>

<sub>Every card links to a released repo &nbsp;·&nbsp; <a href="https://cubecoach-three.vercel.app">CubeCoach demo</a> &nbsp;·&nbsp; <a href="https://shua-labs.vercel.app">Shua Labs site</a></sub>
